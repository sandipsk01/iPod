        ...
        return (
            <div className="wheel-container" id="wheel-container">
                <div style={{backgroundColor:wheelColor}} className="wheel" id="wheel" >
                    ...
                    <img className="action-icons" src="https://cdn-icons-png.flaticon.com/256/318/318275.png" alt="next" style={{height: 30,width: 30, marginLeft:10}} />
                    </div>
                    <div className="controll" id="play-pause">
                    <img className="action-icons" src="https://cdn-icons-png.flaticon.com/256/2404/2404317.png" alt="pause-next" style={{height: 30,width: 30}} />
                    </div>
                    <div className="controll" id="reverse">
                    <img className="action-icons" src="https://cdn-icons-png.flaticon.com/256/318/318276.png" alt="prev" style={{height: 30,width: 30}} />
                    </div>
                </div>
